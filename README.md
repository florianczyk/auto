    ...
    <div class="container">
        ...
        <fieldset>
            <legend><h2>Wiecej danych pojazdu</h2></legend>
                ...
                <label for="wdpojazdu"> <form > Wartość maksymalna pojazdu <input type="range" id="a" name="a" min="100" max="200000" step="1000" oninput="result.value=a.value"/> <output name="result" for="a">0</output> zł </form> </label> 
